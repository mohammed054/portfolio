      ...
      {open && (
        <div className="mb-4 bg-white rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.15)] w-[280px] overflow-hidden">
          <div className="bg-[#A886CD] px-5 py-4 flex items-center justify-between">
            <div>
              <p className="text-white font-semibold text-sm font-europa">Contact Us</p>
          ...
          <div className="p-4 space-y-2">
            <a href="tel:+201098083841" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-light-bg transition-colors group">
              <div className="w-10 h-10 bg-[#25D366] rounded-full flex items-center justify-center text-white shrink-0">
                <Phone size={18} />
              </div>
              <div>
                <p className="text-sm font-semibold text-text-dark font-europa">Phone</p>
                <p className="text-xs text-text-muted">+20 109 808 3841</p>
              </div>
            </a>
            <a href="https://wa.me/201098083841" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-light-bg transition-colors group">
              <div className="w-10 h-10 bg-[#25D366] rounded-full flex items-center justify-center text-white shrink-0">
              ...
              <div>
                <p className="text-sm font-semibold text-text-dark font-europa">WhatsApp</p>
                <p className="text-xs text-text-muted">+20 109 808 3841</p>
              </div>
            </a>
            <a href="mailto:info@sabernasr.com" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-light-bg transition-colors group">
              ...
              <div>
                <p className="text-sm font-semibold text-text-dark font-europa">Email</p>
