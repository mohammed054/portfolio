...
function ChatWidget() {
  return (
    <div className="fixed bottom-6 left-6 z-40 flex items-center gap-3 max-sm:bottom-4 max-sm:left-4">
      ...
      <button className="w-14 h-14 bg-[#A886CD] rounded-full flex items-center justify-center text-white shadow-[0_4px_16px_rgba(168,134,205,0.4)] hover:scale-110 transition-transform duration-300">
