...
function GoToTop() {
  ...
  return (
    ...
    >
      <div className="w-10 h-10 rounded-full flex items-center justify-center bg-primary text-white shadow-[0_2px_12px_rgba(255,91,74,0.3)] group-hover:bg-primary-hover transition-all duration-300">
        <ArrowUp size={16} />
      </div>
